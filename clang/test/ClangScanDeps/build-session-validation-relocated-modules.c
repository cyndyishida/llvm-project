...
// RUN: cp -r %t/fallback_frameworks/MovedDep.framework %t/frameworks/
...
// DEPS1-NEXT: "clang-modulemap-file": "{{.*}}fallback_framework{{.*}}MovedDep.framework
// DEPS1: "name": "MovedDep"

// DEPS2: "clang-module-deps": [],
// DEPS2-NEXT: "clang-modulemap-file": "{{.*}}frameworks{{.*}}MovedDep.framework
// DEPS2: "name": "MovedDep"
...
{
  "directory": "DIR",
  "command": "clang -c DIR/tu1.c -fmodules -fmodules-cache-path=DIR/cache -FDIR/frameworks -FDIR/fallback_frameworks  -fbuild-session-file=DIR/session.timestamp -fmodules-validate-once-per-build-session -o DIR/tu1.o ",
  "file": "DIR/tu1.c"                                                                       
}
]
