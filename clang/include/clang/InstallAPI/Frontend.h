...
public:
  ...
  /// symbol. \param CategoryName The name of category, not symbol. \param Avail
  /// The availability information tied to the active target triple. \param D
  /// The pointer to the declaration from traversing AST. \param Access The
  /// intended access level of symbol. \return The non-owning pointer to added
  /// record in slice.
